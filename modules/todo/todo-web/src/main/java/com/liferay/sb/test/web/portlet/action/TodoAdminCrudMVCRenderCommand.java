...
public class TodoAdminCrudMVCRenderCommand implements MVCRenderCommand {

	/**
	 * Edit Page JSP file
	 */
	public String getEditPageJSP() {
		return TodoWebKeys.ADMIN_EDIT_JSP;
	}
	...
	public String getViewPageJSP() {
		return TodoWebKeys.ADMIN_VIEW_JSP;
	}
	...
	public String getViewRecordPageJSP() {
		return TodoWebKeys.ADMIN_VIEW_RECORD_JSP;
	}
